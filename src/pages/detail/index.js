...
export function Detail() {
    ...
    navigation.setOptions({
      ...
      headerRight: () => (
        <Pressable onPress={() => handleFavoriteReceipe(route.params?.data)}>
          {favorite ? (
            <Entypo name="heart" size={28} color="#FF4141"></Entypo>
          ) : (
            <Entypo name="heart-outlined" size={28} color="#FF4141"></Entypo>
          )}
        </Pressable>
      ),
    });
  ...
  async function shareReceipe() {
    try {
      await Share.share({
        url: "https://www.linkedin.com/in/guilhermefdias/",
    ...
    >
      <Pressable onPress={handleOpenVideo}>
        <View style={styles.playIcon}>
          <AntDesign name="playcircleo" size={48} color="#FAFAFA"></AntDesign>
        </View>
        <Image
      ...
      <View style={styles.headerDetails}>
        ...
        <Pressable onPress={shareReceipe}>
          <Feather name="share-2" size={24} color="#121212"></Feather>
        </Pressable>
      </View>
